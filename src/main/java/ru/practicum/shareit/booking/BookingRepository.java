...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    List<Long> getAllBookingItemsForUserStatus(@Param("owner") Long owner, @Param("status") Status status);
    ...
    List<Long> findBookingsToAddComment(@Param("bookerId") Long bookerId, @Param("itemId") Long itemId,
                                        @Param("localDateTime") LocalDateTime localDateTime, @Param("status") Status status);
