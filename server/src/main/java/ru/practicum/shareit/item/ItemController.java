...
public class ItemController {
    ...
    public ItemDto addNewItem(@Validated(Create.class) @RequestBody ItemDto itemDto,
                              @RequestHeader(value = HEADER_REQUEST) Long userId) throws EntityNotFoundException {
    ...
    @GetMapping()
    @ResponseStatus(HttpStatus.OK)
    public List<ItemDtoForOwner> getItemsByUser(@RequestHeader(value = HEADER_REQUEST) Long userId) {
    ...
    @GetMapping("/search")
    @ResponseStatus(HttpStatus.OK)
    public List<ItemDto> searchItem(@RequestHeader(value = HEADER_REQUEST) Long userId,
    ...
    @ResponseStatus(HttpStatus.OK)
    public CommentDto addComment(@RequestHeader(value = HEADER_REQUEST) Long userId,
